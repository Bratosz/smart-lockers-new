package pl.bratosz.smartlockers.service.jgenderize.model;

import java.io.Serializable;

public class NameGender implements Serializable, Comparable<NameGender> {
    ...
    public boolean isNull() { return Gender.NULL.equals(this.getGenderType());}
    ...
    @Override
    public int compareTo(NameGender o) {
        return this.getProbability().compareTo(o.getProbability());
    }
}
